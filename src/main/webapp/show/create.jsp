...
<main>
    ...
    <div class="card container px-6" style="height: 150vh; width: 45% ; background-color: #eceeee ">
        <form action="/show?action=create" method="post" enctype="multipart/form-data" style="padding: 0 10px">
