...
<div class="container">
    <form action="/location?action=create" method="post">
        <div class="mb-3">
            <label for="code" class="form-label" style="font-weight: bolder;">CITY</label>
            <input type="text" class="form-control" id="code" name="city" required>
        </div>
        <div class="mb-3">
            <label for="importDate" class="form-label" style="font-weight: bolder;">ADDRESS</label>
        ...
        <div class="mb-3">
            ...
            <div class="d-flex">
                <input type="number" class="form-control" id="quantity" name="quantity" style="margin-bottom: 10px; margin-right: 10px; width: 200px" required>
...
<script>
    ...
    function addSeat() {
        ...
        for (let i = 1; i <= seatQuantity; i++) {
            ...
            <div class="col-4" style=" flex-basis: calc(40% - 10px);
    padding-bottom: 5px;">
                <input type="text" class="form-control" name="position" style="width: 200px" required>
            </div>
            <div class="col-3" style=" flex-basis: calc(50% - 10px);
    padding-bottom: 5px;">
                    <select class="form-control" name="type" id="type">
